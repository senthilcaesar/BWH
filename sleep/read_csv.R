...
# APPLES
d <- read.csv("/Users/sq566/Desktop/saps/csv/apples-fileid-demographics-smp-cut-20230215-site.csv", stringsAsFactors=F)
d <- d[ , c( "fileid" , "nsrr_age" , "nsrr_sex") ]
names(d) <- c("ID","age","male")
d$male <- ifelse( d$male == "male" , 1 , 0 )
write.table( d, file="/Users/sq566/Desktop/saps/csv/files/apples.dat" , sep="\t" , row.names=F, col.names=T , quote=F )

# CCSHS
d <- read.csv("/Users/sq566/Desktop/saps/csv/ccshs-trec-dataset-0.7.0.csv", stringsAsFactors=F)
d$ID <- paste("ccshs-trec", formatC(d$nsrrid), sep = "-")
d <- d[ , c( "ID" , "age" , "male") ]
write.table( d, file="files/ccshs.dat" , sep="\t" , row.names=F, col.names=T , quote=F )

# CFS
d <- read.csv("/Users/sq566/Desktop/saps/csv/cfs-visit5-dataset-0.7.0.csv", stringsAsFactors=F)
d$ID <- paste( "cfs-visit5" , d$nsrrid , sep="-" )
d <- d[ , c( "ID" , "age" , "male") ]
write.table( d, file="files/cfs.dat" , sep="\t" , row.names=F, col.names=T , quote=F )

# CHAT baseline
d <- read.csv("/Users/sq566/Desktop/saps/csv/chat-baseline-dataset-0.12.0.csv", stringsAsFactors=F)
d$ID <- paste( "chat-baseline" , d$nsrrid , sep="-" )
d <- d[ , c( "ID" , "ageyear_at_meas" , "male") ]
names(d) <- c("ID","age","male")
write.table( d, file="/Users/sq566/Desktop/saps/csv/files/chat-baseline.dat" , sep="\t" , row.names=F, col.names=T , quote=F )

# CHAT followup
d <- read.csv("/Users/sq566/Desktop/saps/csv/chat-followup-dataset-0.12.0.csv", stringsAsFactors=F)
d$ID <- paste( "chat-followup" , d$nsrrid , sep="-" )
d <- d[ , c( "ID" , "ageyear_at_meas" , "male") ]
names(d) <- c("ID","age","male")
write.table( d, file="/Users/sq566/Desktop/saps/csv/files/chat-followup.dat" , sep="\t" , row.names=F, col.names=T , quote=F )

# CHAT baseline nonrandomized
d <- read.csv("/Users/sq566/Desktop/saps/csv/chat-nonrandomized-dataset-0.12.0.csv", stringsAsFactors=F)
d$ID <- paste( "chat-baseline" , d$nsrrid , sep="-" )
d <- d[ , c( "ID" , "age_nr", "ref9") ]
names(d) <- c("ID","age", "male")
d$male <- ifelse( d$male == 1 , 1 , 0 )
write.table( d, file="/Users/sq566/Desktop/saps/csv/files/chat-nonrandomized.dat" , sep="\t" , row.names=F, col.names=T , quote=F )

# MESA
d <- read.csv("/Users/sq566/Desktop/saps/csv/mesa-sleep-harmonized-dataset-0.6.0.csv", stringsAsFactors=F)
...
# MROS Visit1
d <- read.csv("/Users/sq566/Desktop/saps/csv/mros-visit1-dataset-0.6.0.csv", stringsAsFactors=F)
...
# MROS Visit2
d <- read.csv("/Users/sq566/Desktop/saps/csv/mros-visit2-dataset-0.6.0.csv", stringsAsFactors=F)
...
# MSP
d <- read.csv("/Users/sq566/Desktop/saps/csv/msp-harmonized-dataset-0.1.1.csv", stringsAsFactors=F)
d <- d[ , c( "fileid" , "nsrr_age" , "nsrr_sex") ]
names(d) <- c("ID","age","male")
d$male <- ifelse( d$male == "male" , 1 , 0 )
write.table( d, file="/Users/sq566/Desktop/saps/csv/files/msp.dat" , sep="\t" , row.names=F, col.names=T , quote=F )

# NCHSDB
d <- read.csv("/Users/sq566/Desktop/saps/csv/nchsdb-dataset-harmonized-0.3.0.csv", stringsAsFactors=F)
...
# SHHS 1
d <- read.csv("/Users/sq566/Desktop/saps/csv/shhs1-dataset-0.20.0.csv", stringsAsFactors=F)
...
# SHHS 2
d <- read.csv("/Users/sq566/Desktop/saps/csv/shhs2-dataset-0.20.0.csv", stringsAsFactors=F)
...
# SOF
d <- read.csv("/Users/sq566/Desktop/saps/csv/sof-visit-8-dataset-0.8.0.csv", stringsAsFactors=F)
