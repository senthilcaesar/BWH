function [time,Vflow_out,BB_i_start,BB_i_mid,BB_i_end,BB_t,VI,VE,Ttot,leak,...
    IEratio,VT,Vpeak,Vpeakmean,Apnea_B] = VEfromFlow_sqrt_V16(time,Vflow,sqrt_scaling,ploton)
...
if sqrt_scaling
    if 0
        ...
        [Vflow,leak,IEratio]=sqrtscaling(time,Vflow,ploton);
        leak=leak+leak1;
        if 0
