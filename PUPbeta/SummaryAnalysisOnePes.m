...
try
    ...
    if NwindowsForUA>0
        ...
        if ~DriveincmH2OnotEupnea
            ...
            [Vpassive,Vactive,VEdeciles,Vdrivedeciles,VpassiveCI,VactiveCI,VEdecilesUpper,VEdecilesLower]=VEVdriveAnalysis(100*x,100*y,100*ArThresActive,ploton,100,settings.Nciles,Nbootstrap,settings.NcileLimits,filt121);
        else
            if settings.plotfigs
            ...
            [Vpassive,Vactive,VEdeciles,Vdrivedeciles,VpassiveCI,VactiveCI,VEdecilesUpper,VEdecilesLower]=VEVdriveAnalysis(x*x_,100*y,ArThresActive*x_,ploton,x_,settings.Nciles,Nbootstrap,settings.NcileLimits,filt121);
        end
        ...
        e=e(Ikeep);
        e=e(criteriabreath);
        [Epassive,Eactive,Edeciles,Edeciles_drive,EpassiveCI,EactiveCI,EdecilesUpper,EdecilesLower,EdecilesMean]=VEVdriveAnalysis(x*x_,e,ArThresActive*x_,0,x_,settings.Nciles,Nbootstrap,settings.NcileLimits);
        ...
        [Tpassive,Tactive,Tdeciles,Tdeciles_drive,TpassiveCI,TactiveCI,TdecilesUpper,TdecilesLower,TdecilesMean]=VEVdriveAnalysis(x*x_,decileTime,ArThresActive*x_,0,x_,settings.Nciles,Nbootstrap,settings.NcileLimits);
