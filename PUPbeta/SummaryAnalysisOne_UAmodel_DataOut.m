function [Vpassive,Vactive,VEdeciles,Vdrivedeciles,VpassiveCI,VactiveCI,Vcomp,VcompCI]=SummaryAnalysisOne_UAmodel_DataOut(DataOut,ArThresPSG1,varlist,ploton,settings)
global SAfontsize
...
%     end
    [t x y a win nota veup hyp ttot] = VEVdriveArray2(DataOut); %DataOut{1}(criteriaUA==1)
    ...
    [Vpassive,Vactive,VEdeciles,Vdrivedeciles,VpassiveCI,VactiveCI]=...
        VEVdriveAnalysis(100*x,100*y,100*arthresPSG2,ploton,100,settings.Nciles,Nbootstrap);
