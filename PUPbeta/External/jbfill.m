...
if 0
    ...
    b=a-1*rand(1,20);%2nd vector of data points;
    x=1:20;%horizontal vector
    figure(1); clf(figure(1));
    loglog(x,a,'r'); hold on;
    loglog(x,b,'b');
    
    [ph,msg]=jbfill(x,a,b,[0.5 0.5 0.5],[0.5 0.5 0.5],0,0);
    
    %[ph,msg]=jbfill(x,a,b,rand(1,3),rand(1,3),0,rand(1,1)) %original example
