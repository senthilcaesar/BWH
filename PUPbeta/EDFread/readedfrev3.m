function [x,Fs,Start_date,Start_time,Label,Dimension,Filt,Coef,Nmb_chans,N] = readedfrev3(fname,ch,t1,t2,fid)
...
if isempty(Nmb_chans)
    disp('warning: zero channels of signal data in this EDF apparently');
end
