function [Rvalue,Pvalue,Pvalue2,Xmodel,Xmodel_sem]=plotregressionwithSEM_powerlaw(xdata,ydata)
...
[ydatamodel,delta] = nlpredci(@(Xmodel,xdataline) fun(Xmodel,xdataline),xdataline,Xmodel,RESIDUAL,'Jacobian',JACOBIAN);
