function [SnoreInterpStruct, SnoreStruct] = ProcessSnoreNew(Snore,Flow,Time,ChannelsList,Channels_Fs,PlotSnore)
...
%         ncoef = 12;
        ncoef = 2 + round(Fs / 1000); % rule of thumb for human speech is fs/1000
        formants = nan(1,10);
