%% This is to maintain backwards compatibility with the development code
function [FlowLimCertOutA, pihat, PrOut2, FlowLimCertOut] = computeFLcertaintyWpihat(FinalModelTable,BreathFLDataTable)
