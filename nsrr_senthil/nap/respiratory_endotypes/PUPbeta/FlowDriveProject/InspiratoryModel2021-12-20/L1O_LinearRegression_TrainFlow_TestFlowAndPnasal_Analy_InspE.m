...
if 1 % this is the final run
    %load('C:\Users\s4235757\Desktop\temp\PAH_PVT\2021-12-20 FlowDrive Insp Only Model\FlowDrive_only25Hz_ReNormalized_FeatureSpace_AutoRef2_Edi_Clean_FinalRun2.mat');
    % above feature space outputs publication final model table however
    % some of the names need to be translated
    load('C:\Users\s4235757\Desktop\temp\PAH_PVT\2021-12-20 FlowDrive Insp Only Model\FlowDrive\Analyzed\Publication\FlowDrive_only25Hz_ReNormalized_FeatureSpace_AutoRef2_Edi_Clean_LinRegWorkspace_TrainFlow_TestFlowAndPnasal__n000.mat');
    % above feature space outputs publication final model table exactly
    load("C:\Users\s4235757\Desktop\temp\PAH_PVT\2021-12-20 FlowDrive Insp Only Model\FlowDrive\Analyzed\Publication\FlowDrive_only25Hz_ReNormalized_FeatureSpace_AutoRef2_Edi_Clean_Workspace_TrainFlow_TestFlowAndPnasal_InspOnly_n000.mat");
end
settings.datadir = 'C:\Users\s4235757\Desktop\temp\PAH_PVT\2021-12-20 FlowDrive Insp Only Model\FlowDrive\Analyzed\Publication\';
...
uniqueftrs = [1:1:240]; % 240 for inspiratory only features, 495 for all features
...
FlowModel = 1; % Set one for flow, zero for pnasal
