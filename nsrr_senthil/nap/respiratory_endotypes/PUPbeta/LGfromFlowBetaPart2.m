...
% plot
if (isfield(settings,'flowdrivelgplotcombined') && settings.flowdrivelgplotcombined==1)
    PlotFlowDriveLGCombined(SigT,BreathDataTable,Vflow_out, VI, Veupnea, E1, AR3, TimeB, Ecentralapnea, Ttot_ser, Ttot_ser_prev, AR1, E, BB_i_start, BB_i_mid, BB_i_end, BB_t, VraOn, Ab, Th, Time, hypnog, spo2, Arousal, position_mode, Percent_position);
end
