...
% EventDepth.EventDepth_All90_SupineN2N3 = CalculateEventDepth(Boxes,RespT,LastEvtBr,0.9,0.9,'Supine','N2N3','mean');
...
elseif strcmp(pos,'Nonsupine') && strcmp(sleep,'REM')
    VIidx = RespT.Position~=1 & RespT.Epochs==3; 
elseif strcmp(pos,'Supine') && strcmp(sleep,'N2N3')
    VIidx = RespT.Epochs == 1 | RespT.Epochs == 2; 
end
